...
silent only
cd ~/code/semantic-biogps
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/code/grunt-express-workflow/test/frontend/app/config.js
badd +1 ~/code/grunt-express-workflow/bower.json
badd +1 ~/code/grunt-express-workflow/.bowerrc
badd +1 ~/code/grunt-express-workflow/node-inspector.js
badd +142 ~/code/grunt-express-workflow/server.js
badd +349 ~/code/grunt-express-workflow/Gruntfile.js
badd +1 Gruntfile.js
badd +0 grunt.js
badd +0 ~/code/grunt-express-workflow/package.json
badd +52 ~/.vimrc
args ~/code/grunt-express-workflow
edit grunt.js
...
exe 'vert 1resize ' . ((&columns * 77 + 136) / 273)
exe 'vert 2resize ' . ((&columns * 77 + 136) / 273)
exe '3resize ' . ((&lines * 53 + 40) / 81)
exe 'vert 3resize ' . ((&columns * 117 + 136) / 273)
exe '4resize ' . ((&lines * 25 + 40) / 81)
...
silent! normal! zE
let s:l = 75 - ((74 * winheight(0) + 39) / 79)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
normal! 020|
lcd ~/code/semantic-biogps
wincmd w
argglobal
edit ~/code/semantic-biogps/Gruntfile.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
wincmd w
argglobal
edit ~/code/grunt-express-workflow/package.json
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal tabstop=2
setlocal tags=~/code/grunt-express-workflow/.git/javascript.tags,~/code/grunt-express-workflow/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
13
normal! 0
lcd ~/code/grunt-express-workflow
wincmd w
argglobal
edit ~/code/grunt-express-workflow/Gruntfile.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((24 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
